...
pygame.init()
pygame.mixer.init()
pygame.mixer.music.load("assets/music/viacheslavstarostin-game-gaming-video-game-music-471936.mp3")
...
start_img = pygame.image.load("assets/music/start_game.jpg")
start_img = pygame.transform.scale(start_img, (900, 950))
start_counter = 0
show_start = True
while show_start:
    timer.tick(fps)
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
            exit()
    if start_counter > 300:  # 5 seconds
        show_start = False
    start_counter += 1
    pygame.display.flip()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_DOWN:
                direction_command = 3
            if event.key == pygame.K_SPACE and (game_over or game_won) and lives > 0:
                powerup = False
                power_counter = 0
                lives -= 1
                startup_counter = 0
